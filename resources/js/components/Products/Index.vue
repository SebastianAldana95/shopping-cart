        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-wrap -m-4" v-if="!products.length">
                <div class="lg:w-1/4 md:w-1/2 p-4 w-full mb-4">
                    <a class="block relative h-48 rounded overflow-hidden">
                        <img src="https://dummyimage.com/420x260" alt="ecommerce image" class="object-over object-center w-full h-full block">
                    </a>
                    <div class="mt-4">
            ...
            <div class="flex flex-wrap -m-4" v-else>
                ...
                >
                    ...
                    >
                        <img src="https://dummyimage.com/420x260" alt="ecommerce image" class="object-cover object-center">
                    </router-link>
                    <div class="mt-4">
                        ...
                        ></h2>
                        <p class="mt-1"
                            v-text="formatCurrency(product.price)"></p>
                    </div>
                </div>
            </div>
        </div>
